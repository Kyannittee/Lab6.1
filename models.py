...
class Course(Base):
    ...
    reviews: Mapped[List["Review"]] = relationship(back_populates="course", order_by="Review.created_at.desc()")
...
class Review(db.Model):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    rating: Mapped[int] = mapped_column(nullable=False)  # оценка от 0 до 5
